Athena is also score-liney. I havetn decided the project name. 
### Description

Defines the architecture, coding standards, folder organization, technology stack, conventions, and engineering principles for the Athena project. Use this skill whenever generating, modifying, or reviewing code for the project.
